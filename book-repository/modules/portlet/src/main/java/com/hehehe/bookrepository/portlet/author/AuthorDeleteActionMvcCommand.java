...
@Component(
		...
		property = { 
				...
				"mvc.command.name=author/delete/save" }, 
		service = MVCActionCommand.class)
public class AuthorDeleteActionMvcCommand extends BaseMVCActionCommand {
	@Reference
	...
	protected void doProcessAction(ActionRequest actionRequest, ActionResponse actionResponse) throws Exception {
		...
		try {
			...
			SessionErrors.add(actionRequest, "wrong-to-delete-author");
		}
	}
}
