...
@Component(immediate = true, property = { 
		...
		"javax.portlet.display-name=CategoryModule", 
		"javax.portlet.init-param.template-path=/category/",
...
public class CategoryModulePortlet extends MVCPortlet {
	@Reference
	...
	public void doView(RenderRequest renderRequest, RenderResponse renderResponse)
		...
		renderRequest.setAttribute("totalCategory", categoryService.getCategoriesCount());
		renderRequest.setAttribute("entries", categoryService.getCategories(from, to, new CategoryNameComparator()));
