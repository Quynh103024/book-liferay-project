...
@Component(
		...
		property = { 
				...
				"mvc.command.name=book/delete/save" }, 
		service = MVCActionCommand.class)
public class BookDeleteActionMvcCommand extends BaseMVCActionCommand {
	@Reference
	...
	protected void doProcessAction(ActionRequest actionRequest, ActionResponse actionResponse) throws Exception {
		...
		try {
			...
			SessionErrors.add(actionRequest, "wrong-to-delete-book");
		}
	}
}
