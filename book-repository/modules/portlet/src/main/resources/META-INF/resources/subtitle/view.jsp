...
<liferay-ui:search-container delta="10"
	...
	<liferay-ui:search-container-row
		...
		<liferay-ui:search-container-column-text name="Actions">
			...
			<portlet:renderURL var="SubtitleDetailURL">
				<portlet:param name="mvcRenderCommandName" value="subtitle/detail/view" />
				<portlet:param name="subtitleId" value="${entry.subtitleId}" />
			</portlet:renderURL>
			<aui:a cssClass="btn btn-primary" href="${SubtitleDetailURL}">Details</aui:a>
			...
			<aui:a cssClass="btn btn-danger" href="${SubtitleDeleteURL}"
				onclick="return confirm('Are you sure you want to delete this subtitle?\n(This will also delete all books associated with the subtitle)');">Delete</aui:a>
